...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">{{__('Uom List')}}</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>  
      ...
      <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ route('uoms.create') }}"> Create New Uoms</a>
            </div>         
        </div>
      </div>
          ...
          table = jQuery('#tableData').DataTable({
            ...
            'columns': [
              ...
              },
              {
                ...
                'className': 'col-md-3',
                'render': function(data, type, row) {
                  var buttonHtml = '<a class="btn btn-info" href="'+url+'/uoms/'+row.id+'">Show</a>&nbsp;&nbsp;<a class="btn btn-primary" href="'+url+'/uoms/'+row.id+'/edit">Edit</a>&nbsp;&nbsp;<a class="btn btn-danger" href="javascript:void(0);" onclick="deleteData('+row.id+')">Delete</a>';
                  return buttonHtml;
                }
              }
            ]
  ...
  function deleteData(id){
    $.confirm({
        ...
        buttons: {
            confirm: function () {
              $('#deleteRow').attr('action', url+"/clients/"+id).submit();  
            },
            cancel: function () {
                return true;
            }
