...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">{{__('Vehicle List')}}</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>  
	...
	<!-- /#page-wrapper -->
  {!! Form::open(['method' => 'DELETE','route' => ['brands.destroy', 1],'id'=>'deleteData','style'=>'display:inline']) !!}
          ...
          table = jQuery('#tableData').DataTable({
            ...
            'columns': [
              ...
              },            
              {
                ...
                'className': 'col-md-3',
                'render': function(data, type, row) {
                  var buttonHtml = '<a class="btn btn-primary" href="'+url+'/vehicles/'+row.id+'/edit">Edit</a>&nbsp;&nbsp;<a class="btn btn-danger" href="javascript:void(0);" onclick="deleteData('+row.id+')">Delete</a>';
                  return buttonHtml;
                }
              }
            ]
...
function deleteData(id){
  ...
  $.confirm({
      ...
      buttons: {
          confirm: function () {
            $('#deleteBrand').attr('action', url+"/vehicles/").submit();  
          },
          cancel: function () {
              return true;
          }
