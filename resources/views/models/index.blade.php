...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">{{__('Model List')}}</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>  
          ...
          table = jQuery('#tableData').DataTable({
            ...
            'columns': [
              ...
              },
              {
                ...
                'className': 'col-md-3',
                'render': function(data, type, row) {
                  var buttonHtml = '<a class="btn btn-info" href="'+url+'/models/'+row.id+'">Show</a>&nbsp;&nbsp;<a class="btn btn-primary" href="'+url+'/models/'+row.id+'/edit">Edit</a>&nbsp;&nbsp;<a class="btn btn-danger" href="javascript:void(0);" onclick="deleteData('+row.id+')">Delete</a>';
                  return buttonHtml;
                }
              }
            ]
