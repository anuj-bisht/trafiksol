...
@section('content')
	...
	<div id="page-wrapper">
		<div class="container-fluid">
            ...
            <div class="row">
                    <div class="col-lg-10">
                        <h1 class="page-header">{{__('Edit Store')}}</h1>                        
                    </div>		                    
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('project_id', $projects,$equipment->project_id, array('class' => 'form-control','placeholder' => 'Please Select','id'=>'project_id')) !!}
                    </div>
                </div>
                
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Chanage Number:</strong>
                        {!! Form::select('chainage', $chainage,$equipment->chainage, array('class' => 'form-control','id'=>'chainage_id')) !!}
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Brand:</strong>
                        {!! Form::select('main_brand_id', $brand, $selected_main_brand_id, array('class' => 'form-control','placeholder' => 'Please Select','id'=>'main_brand_id')) !!}
                    </div>
                </div>

                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Brand Device:</strong>
                        {!! Form::select('brand_id', $brands,$equipment->brand_id, array('class' => 'form-control','id'=>'sub_brand_id')) !!}
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Equpment SLA:</strong>
                        {!! Form::select('equipment_sla_id', $equipment_sla_list,$equipment->equipment_sla_id, array('class' => 'form-control','id'=>'sla_id')) !!}
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('store_type', ["Store"=>"Store Item","Return"=>"Return Item"],, array('placeholder' => 'Item Type','class' => 'form-control')) !!}
                    </div>
                </div>
