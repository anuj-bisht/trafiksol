...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">{{__('Client List')}}</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>  
  ...
  <script>
    ...
    jQuery(document).ready(function() {
          ...
          table = jQuery('#tableData').DataTable({
            ...
            {extend:'csvHtml5',
              exportOptions: {
                columns: [0, 2]//"thead th:not(.noExport)"
              },
            ...
            'columns': [
              ...
              },
              {
                ...
                'className': 'col-md-3',
                'render': function(data, type, row) {
                  var buttonHtml = '<a class="btn btn-info" href="'+url+'/clients/'+row.id+'">Show</a>&nbsp;&nbsp;<a class="btn btn-primary" href="'+url+'/clients/'+row.id+'/edit">Edit</a>&nbsp;&nbsp;<a class="btn btn-danger" href="javascript:void(0);" onclick="deleteData('+row.id+')">Delete</a>';
                  return buttonHtml;
                }
              }
            ]
