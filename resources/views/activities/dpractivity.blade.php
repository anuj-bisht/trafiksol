...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">{{__('Activity DPR List')}}</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>  
  ...
  <script>
    ...
    jQuery(document).ready(function() {
          ...
          table = jQuery('#tableData').DataTable({
            ...
            {extend:'csvHtml5',
              exportOptions: {
                columns: [1,2,3,4,5,6,7]//"thead th:not(.noExport)"
              },
            ...
            'ajax': {
              'url': '{{ url("/") }}/activities/ajaxDprData',
              'headers': {
            ...
            'columns': [                         
              ...
              },            
              {
                ...
                'className': 'col-md-1',
                'render': function(data, type, row) {
                  var buttonHtml = '<a class="btn btn-primary" href="'+url+'/activities/dprshow/'+row.id+'">show</a>';
                  return buttonHtml;
                }
              }
            ]
