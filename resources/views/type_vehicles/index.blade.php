...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">{{__('Vehicle Type List')}}</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>  
      ...
      <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ route('type_vehicles.create') }}"> Create New Vehicle Type</a>
            </div>
        </div>
      </div>
	...
	<!-- /#page-wrapper -->
  {!! Form::open(['method' => 'DELETE','route' => ['type_vehicles.destroy', 1],'id'=>'deleteData','style'=>'display:inline']) !!}
  ...
  <script>
    ...
    jQuery(document).ready(function() {
          ...
          table = jQuery('#tableData').DataTable({
            ...
            'ajax': {
              'url': '{{ url("/") }}/type_vehicles/ajaxData',
              'headers': {
            ...
            'columns': [
              ...
              },            
              {
                ...
                'className': 'col-md-2',
                'render': function(data, type, row) {
                  var buttonHtml = '<a class="btn btn-primary" href="'+url+'/type_vehicles/'+row.id+'/edit">Edit</a>&nbsp;&nbsp;<a class="btn btn-danger" href="javascript:void(0);" onclick="deleteData('+row.id+')">Delete</a>';
                  return buttonHtml;
                }
              }
            ]
...
function deleteData(id){
  ...
  $.confirm({
      ...
      buttons: {
          confirm: function () {
            $('#deleteData').attr('action', url+"/type_vehicles/").submit();  
          },
          cancel: function () {
              return true;
          }
