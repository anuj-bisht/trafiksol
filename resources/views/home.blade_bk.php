						...
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge" id="totalTickets"><img src="{{asset('/images/loading-36.gif')}}" style="width: 25%;"></div>
					...
					<div class="panel panel-green">
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge" id="openTickets"><img src="{{asset('/images/loading-36.gif')}}" style="width: 25%;"></div>
					...
					<div class="panel panel-yellow">
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right" >
									<div class="huge" id="closeTickets"><img src="{{asset('/images/loading-36.gif')}}" style="width: 25%;"></div>
					...
					<div class="panel panel-red">
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge" id="remHrTickets"><img src="{{asset('/images/loading-36.gif')}}" style="width: 25%;"></div>
					...
					<div class="panel panel-blue">
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge" id="pausedTicket"><img src="{{asset('/images/loading-36.gif')}}" style="width: 25%;"></div>
					...
					<div class="panel panel-blue">
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge" id="hardware_req"><img src="{{asset('/images/loading-36.gif')}}" style="width: 25%;"></div>
    ...
    function getAllData()
    {
        ...
        jQuery.ajax({
            ...
            success:function(response)
            {
                ...
                {
                    jQuery('#totalTickets').html(response.tickets.length);
                    var openTickets = 0;
                    var closeTickets = 0;
                    var remHrTickets = 0;
                    var pausedTicket = 0;
