...
class TicketController extends Controller
{
    ...
    public function hwrequestAjax(Request $request)
    {
        ...
        try {
            ...
            $obj = HardwareRequest::select('hardware_requests.*','users.name as username','tickets.subject')            
    ...
    function GetData(Request $request){
        ...
        ->select('tickets.*','users.name as created',DB::raw('(CASE WHEN tickets.close_time = "" THEN "Open Ticket" 
...
public function reportpdf(Request $request){
    ...
    public function printpdf(Request $request)
    {
        ...
        ->join('ticket_categories', 'tickets.ticket_category_id','=', 'ticket_categories.id')
        ->join('ticket_issue_types', 'tickets.issue_type_id','=', 'ticket_issue_types.id')
        ->select( 'tickets.*','users.name as created', 'equipments.title as equipment', 'ticket_categories.name as ticket_categories', 'ticket_issue_types.name as issue','clients.image as client_image','clients.name as client_name')
		...
		return view('tickets.print', compact('data','chart1'));

        //$pdf = PDF::loadView('tickets.print', compact('data'));
